...
def main():
    ...
    # Legacy aggregate remains available to editorial tooling. Reader UI should use
    # the semantic V3 projections below rather than treat graph.json as source-of-truth.
    ...
    sync_app_data()
    print('Build completed. Semantic V3 projections and legacy JSON synced to app/public/data.')
